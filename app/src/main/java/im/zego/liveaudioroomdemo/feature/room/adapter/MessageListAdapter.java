...
public class MessageListAdapter extends RecyclerView.Adapter<MessageListAdapter.MessageHolder> {
    List<ZegoLiveAudioRoomText> messageList;

    public MessageListAdapter(List<ZegoLiveAudioRoomText> messageList) {
    ...
    public void onBindViewHolder(@NonNull MessageHolder holder, int position) {
        ZegoLiveAudioRoomText message = messageList.get(position);
    ...
    private boolean isOwnerMessage(ZegoLiveAudioRoomText message) {
