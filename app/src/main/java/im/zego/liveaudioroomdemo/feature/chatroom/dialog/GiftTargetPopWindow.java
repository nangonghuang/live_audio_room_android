        ...
        recyclerView.addOnItemTouchListener(new OnRecyclerViewItemTouchListener(recyclerView) {
            ...
            public void onItemClick(RecyclerView.ViewHolder vh) {
                ...
                if (adapterPosition == 0) {
                    ...
                    String chatRoomUser = userList.get(adapterPosition - 1);
                    target.add(chatRoomUser);
                }
    ...
    private static class GiftTargetAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            if (position == 0) {
                ...
                String zimChatRoomUserID = userList.get(position - 1);
                String chatRoomUserName = ZIMChatRoomManager.getInstance().getChatRoomUserName(zimChatRoomUserID);
                itemView.setText(chatRoomUserName);
            }
        }
